<template>
        <div id="demo" style="overflow: hidden;width:1100px;height:40px;">
                <div id="indemo" style="float: left;width:880%;height:40px;">
                    <div ref="content" id="demo1" style="float:left;height:40px;">
                        <slot></slot>
                    </div>
                    <div id="demo2" style="float: left;height:40px;">
                    </div>
                </div>
        </div>
</template>
